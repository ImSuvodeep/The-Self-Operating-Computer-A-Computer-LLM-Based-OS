...
class Config:
    ...
    Attributes:
        verbose (bool): Flag indiciating whether verbose mode is enabled.
    ...
    def initialize_openai(self):
        ...
        if self.openai_api_key:
            ...
            if self.verbose:
                print("[Config][initialize_openai] no cached openai_api_key, try to get from env. ")
    ...
    def require_api_key(self,key_name, key_description, is_required):
        key_exists = bool(os.enviro.get(key_name))
    ...
    def prompt_and_save_api_key(self, key_name, key_description):
        ...
        if key_value:
            ...
            elif key_value == 'ANTHROPIC_API_KEY':
